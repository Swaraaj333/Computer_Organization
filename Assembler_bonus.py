#CSE_112_PROJECT
#CO_2025
#Sameeksha Jain 2024500 Swaraaj Krishna 2024574 Kanak Gupta 2024191 Priyansh Malu 2024439
#This is a group prject where everyone made significant contributions 
...
def fn3(a):
    d = {
        '000': ['add', 'sub', 'addi', 'jalr', 'beq'],'011': ['mul'],
        '010': ['slt', 'lw', 'sw'],
        '101': ['srl'],
        '110': ['or'],
        '111': ['and'],
    ...
    for i in d:
      ...
      raise Exception("Undefined Instruction2")
...
try:
        with open(r'C:\Users\KANAK GUPTA\OneDrive\Documents\CO\Group_126\Bonus\ass_input.txt', 'r') as f:
        ...
        with open(r'C:\Users\KANAK GUPTA\OneDrive\Documents\CO\Group_126\Bonus\ass_bonus_output1.txt', 'w') as fh:            
            binry = typ = ''
            temp = labladdress(instrn) #getting a dictionary of labels and corresponding addresses
            pc = 0
            d = {
                'R': ['add', 'sub', 'slt', 'srl', 'or','and','mul'],
                'I': ['lw', 'addi', 'jalr'],
                'S': ['sw'],
                'B': ['beq', 'bne'],
                'J': ['jal'],
            ...
            for i in instrn:
                ...
                for j in d:
                    ...
                    raise Exception("Undefined Instruction1")
                ...
                try:           
                    if typ == 'R':
                        ...
                        binry='00000000000000000000000000000000'
                    elif typ=='rvrs':
                        binry='000000000000'+ reg(i[2]) + '000' + reg(i[1]) + opcode(typ, i[0])
                    elif typ=='halt':
                        binry='11111111111111111111111111111111'
                        fh.write(binry + '\n')
                        break
